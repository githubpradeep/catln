...
isSubSuffixType (PTypeName a) (PClassName b) = False
isSubSuffixType (PClassName a) (PTypeName b) = False
...
isSuffixType (TypeVar (TVVar a)) (TypeVar (TVArg b)) = False
isSuffixType (TypeVar (TVArg a)) (TypeVar (TVVar b)) = False
...
intersectPartial (PTypeName a) (PClassName b) = False
intersectPartial (PClassName a) (PTypeName b) = False
